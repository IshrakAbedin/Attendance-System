...
CREATE TABLE CLASSHUB(
    TNAME VARCHAR2(25),
    SECTION VARCHAR2(15),
    CLASS VARCHAR2(15),
    CONSTRAINT PK_DEMOCLASSHUB PRIMARY KEY (TNAME, SECTION, CLASS)
);
...
-- Arbitrary value insertion into CLASSHUB for test purpose
INSERT INTO CLASSHUB VALUES ('DEMOTEACHER', 'DEMOSECTION', 'DEMOCLASS');
INSERT INTO CLASSHUB VALUES ('DEMOTEACHER', 'CSE16', 'CSE9406');
...
SELECT SECTION, CLASS FROM CLASSHUB
